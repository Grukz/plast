...
class Post(_models.Post):
    ...
    def _generate_report(self):
        ...
        self._list(["`{}` [`{}`]".format(match["target"]["identifier"], match["rule"]) for match in _magic._iterate_matches(self.case.resources["matches"])], prefix="These are the matching evidence(s):")
